...
<head>
  ...
  <title>Perutecsols | Panel de Control</title>
  ...
  if (isset($_SESSION["validarSesionBackend"]) && $_SESSION["validarSesionBackend"] === "ok") {
    ...
    if (isset($_GET["ruta"])) {
      ...
      if (
        ...
        $_GET["ruta"] == "editar-proveedor" ||
        $_GET["ruta"] == "editar-ordencompra" ||
        $_GET["ruta"] == "editar-venta" ||
        $_GET["ruta"] == "editar-ventaecomerce" ||
        $_GET["ruta"] == "usuarios" ||
        $_GET["ruta"] == "reportes" ||
        $_GET["ruta"] == "reportesexcel" ||
        $_GET["ruta"] == "mensajes" ||
        $_GET["ruta"] == "perfiles" ||
        $_GET["ruta"] == "perfil" ||
        $_GET["ruta"] == "salir"
...
======================================-->
  ...
  <script src="vistas/js/gestorVentasecommerce.js"></script>
