          ...
          <form role="form" method="post" class="formularioVenta">
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                ?>
                <input type="hidden" id="idVent" name="idVent" value="<?php echo $venta["id"]; ?>">
                <!--=====================================
                ...
                <?php
                if ($venta["codigo"] > 0) {
                  echo '<div class="form-group" id="idbole">

                  <div class="input-group">

                    <span class="input-group-addon"><i class="fa fa-key"></i></span>

                    <input type="text" class="form-control" id="nuevaVenta" name="editarVenta" value="' . $venta["codigo"] . '" readonly>

                  </div>

                </div>';
                } else {
                  echo '  <div class="form-group" id="idfact">

                  <div class="input-group">

                    <span class="input-group-addon"><i class="fa fa-key"></i></span>

                    <input type="text" class="form-control" id="nuevaVentaFact" name="editarVentaFact" value="' . $venta["codigofac"] . '" readonly>
                    ...
                    echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-3 ingresoPrecio" style="padding-left:0px">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control nuevoPrecioProducto" precioReal="' . $respuesta[0]["precio"] . '" name="nuevoPrecioProducto" value="' . $value["total"] . '" readonly required>
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-primary pull-right" id="GuardarVenta">Guardar cambios</button>
