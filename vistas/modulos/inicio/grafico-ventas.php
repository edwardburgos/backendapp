...
error_reporting(0);
$ventas = ControladorVentasecommerce::ctrMostrarVentas();
$totalVentas = ControladorVentasecommerce::ctrMostrarTotalVentas();
  	...
  	<div class="box-footer no-border">
	    ...
	    <div class="row">
	      ...
	      <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
	        ...
	        <input type="text" class="knob" style="color: black;" data-readonly="true" value="<?php echo round($porcentajePaypal); ?>" data-width="60" data-height="60" data-fgColor="#39CCCC">
	      ...
	      <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
	        ...
	        <input type="text" class="knob"  style="color: black;" data-readonly="true" value="<?php echo round($porcentajePayu); ?>" data-width="60" data-height="60" data-fgColor="#39CCCC">
