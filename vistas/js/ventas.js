...
$(window).ready(function() {
	$('#comprobfac').closest('label').click(function() {
		if (mivalor!=document.getElementById("nuevaVenta").value && document.getElementById("nuevaVenta").value!=0 ){
			mivalor=document.getElementById("nuevaVenta").value;
			mivalor2=document.getElementById("nuevaVentaFac").value;
		}
		document.getElementById("nuevaVentaFac").value=mivalor2;
	 document.getElementById("nuevaVenta").value=0;
	 document.getElementById("idfac").style.display="block";
	 document.getElementById("idbol").style.display="none";

	 $('#seleccionarClienteruc').prop("required", true);
	 $("#seleccionarCliente").removeAttr("required");


	 $("#seleccionarCliente").val('').trigger('change');
	
	document.getElementById("dnicliente").style.display="none";
	 document.getElementById("ruccliente").style.display="block";

	 $("#seleccionarClienteruc").select2({ width: '100%' });
...
$(window).ready(function() {
  $('#comprobbol').closest('label').click(function() { 

	document.getElementById("nuevaVenta").value=mivalor;
	document.getElementById("nuevaVentaFac").value=0;
	document.getElementById("idfac").style.display="none";
	document.getElementById("idbol").style.display="block";	

	$("#seleccionarClienteruc").val('').trigger('change');

	$("#seleccionarCliente").select2({ width: '100%' });
	$('#seleccionarCliente').prop("required", true);
	$("#seleccionarClienteruc").val("");
	$("#seleccionarClienteruc").removeAttr("required");
	document.getElementById("dnicliente").style.display="block";
	document.getElementById("ruccliente").style.display="none";
