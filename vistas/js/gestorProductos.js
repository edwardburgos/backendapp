...
function agregarMiProducto(imagen) {
  ...
  if (seleccionarTipo == "virtual") {
    ...
    var detalles = { Talla: " ", Color: " ", Marca: " " };
  }
  ...
  datosProducto.append("fotoPortada", imagenFotoPrincipal);
...
$(".tablaProductos tbody").on("click", ".btnEditarProducto", function () {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      /*=============================================
			CARGAMOS EL PRECIO, PESO Y DIAS DE stock
			=============================================*/
      ...
      if (respuesta[0]["oferta"] != 0) {
        ...
        $("#modalEditarProducto .precioOferta").val(
          respuesta[0]["precioOferta"]
        );
        $("#modalEditarProducto .descuentoOferta").val(
          respuesta[0]["descuentoOferta"]
        );
