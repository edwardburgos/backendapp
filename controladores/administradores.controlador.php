	...
	public function ctrIngresoAdministrador(){
		...
		if(isset($_POST["ingEmail"])){
			...
			}else
			{
			 ...
			 {
				echo '<br>
				<div class="alert alert-warning">Error en Verificar Captcha</div>';	
			...
			if($captcha_error == ''){
				...
				echo '<script> $("#captcha_error").text("'.$captcha_error.'"); </script>';

				//echo '<br><div class="alert alert-danger">"'.$captcha_error.'"</div>';
