	...
	static public function mdlIngresarCliente($tabla, $datos)
	{
		...
		if ($stmt->execute()) {
			...
			if ($count > 0) {
				...
				$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, documento,ruc, email, telefono, direccion, fecha_nacimiento,tipocliente) VALUES (:nombre, :documento,:ruc, :email, :telefono, :direccion, :fecha_nacimiento,'nouser')");
...
/*=============================================
	...
	static public function mdlMostrarClientes($tabla, $item, $valor)
	{
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE $item = :$item AND tipocliente ='nouser'");
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE tipocliente ='nouser'");
