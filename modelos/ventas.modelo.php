...
class ModeloVentas{
	...
	static public function mdlIngresarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo,codigofac, id_cliente, id_vendedor, productos, impuesto, neto, total, metodo_pago) VALUES (:codigo,:codigofac, :id_cliente, :id_vendedor, :productos, :impuesto, :neto, :total, :metodo_pago)");

		$stmt->bindParam(":codigo", $datos["codigo"], PDO::PARAM_INT);
		$stmt->bindParam(":codigofac", $datos["codigofac"], PDO::PARAM_INT);
