...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="background-color:white; width:110px; text-align:center; color:red"><br><br>BOLETA<br>001 Nº $valorVenta</td>
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:540px">Dni:  $respuestaCliente[documento]</td>
...
$valorUnitario = number_format($respuestaProducto[0]["precio"], 2);
